...
export const metadata: Metadata = {
  title: "Louvre Art Gallery | Where Art Meets Eternity",
  description: "Experience the world's finest collection of masterpieces including Mona Lisa and Venus de Milo in the heart of Paris. Plan your visit to discover art history.",
  keywords: "Louvre, art gallery, Mona Lisa, Venus de Milo, Paris museum, art collection, masterpieces, Leonardo da Vinci",
  metadataBase: new URL("https://louvre-gallery.com"),
  alternates: {
    canonical: "https://louvre-gallery.com"
  },
  openGraph: {
    title: "Louvre Art Gallery | Where Art Meets Eternity",
    description: "Experience the world's finest collection of masterpieces including Mona Lisa and Venus de Milo in the heart of Paris.",
    url: "https://louvre-gallery.com",
    siteName: "Louvre Gallery",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763398387474-1lk1tm8c.jpg",
        alt: "Louvre Gallery interior with masterpieces"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Louvre Art Gallery | Where Art Meets Eternity",
    description: "Experience the world's finest collection of masterpieces including Mona Lisa and Venus de Milo in the heart of Paris.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763398387474-1lk1tm8c.jpg"]
  },
  robots: {
    index: true,
    follow: true
